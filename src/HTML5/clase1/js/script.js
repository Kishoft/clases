...
let inputOracion = document.getElementById("oracion");
let btnTransformar = document.getElementById("transformar");
...
btnTransformar.addEventListener("click", event => {
    ...
    Molestron.textoAMinusculas(inputOracion.value)
    .then(texto => Molestron.reemplazarVocales("i", texto))
    .then(texto => Molestron.alternarMinusMayus(texto))
